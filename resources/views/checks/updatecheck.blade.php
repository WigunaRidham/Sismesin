...
@section('content')
    <div class="box box-primary col-md-10 col-md-offset-1">
        <div class="box-header h3">Form Pengecekan Data Kendaraan</div>
        <div class="box-body">
            @if($errors->all())
            ...
            <form role="form" action="{{ route('check.update', ['id' => $vehicle->id]) }}" method="post">
                {{ csrf_field() }}
                {{ method_field('PUT') }}

                <div class="row setup-content" id="step-1">
                    <div class="col-xs-12 margin-bottom">
                        <h3 class="text-center">Step 1 Form Pengujian Berkala Kendaraan Bermotor</h3>
                        <div class="col-md-12" style="border-color: #d0d3d7;">
                            <hr>
                            <div class="header margin-bottom"><h3>Data Kendaraan</h3></div>
                            <div class="col-md-6">
                                <div class="form-group col-md-12 no-padding">
                                    <label class="control-label col-md-4">Nama Pemilik <a style="text-decoration:none;font-size: 1em">*</a></label>
                                    <div class="col-md-8">
                                        <input maxlength="200" type="text" required="required" name="nama"
                                               value="{{ $vehicle->nama }}"
                                ...
                                <div class="form-group col-md-12 no-padding">
                                    ...
                                    <div class="col-md-8">
                                <textarea maxlength="255" type="text" required="required"
                                          name="alamat" class="form-control" rows="3"
                                          placeholder="Masukan Alamat" >{{ $vehicle->alamat }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group col-md-12 no-padding">
                                    <label class="control-label col-md-4">No. Landasan <a style="text-decoration:none;font-size: 1em">*</a></label>
                                    <div class="col-md-8">
                                        <input maxlength="200" type="text" required="required" name="no_landasan"
                                               value="{{ $vehicle->no_landasan }}"
                                ...
                                <div class="form-group col-md-12 no-padding">
                                    ...
                                    <div class="col-md-8">
                                        <input maxlength="200" type="text" required="required" name="no_mesin"
                                               value="{{ $vehicle->no_mesin }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group col-md-12 no-padding">
                                    ...
                                    <div class="col-md-8">
                                        <input maxlength="200" type="text" required="required" name="no_kendaraan"
                                               value="{{ $vehicle->no_kendaraan }}"
                                               class="form-control" placeholder="Masukkan Nomer Kendaraan" />
                                    </div>
                                </div>
                                <div class="form-group col-md-12 no-padding">
                                    <label class="control-label col-md-4">Merk/Tipe/Tahun <a style="text-decoration:none;font-size: 1em">*</a></label>
                                    <div class="col-md-8">
                                        <input maxlength="200" type="text" required="required" name="merk_tipe_tahun"
                                               value="{{ $vehicle->merk_tipe_tahun }}"
                                ...
                                <div class="form-group col-md-12 no-padding">
                                    ...
                                    <div class="col-md-8">
                                        <input maxlength="200" type="text" required="required" name="jenis_kendaraan"
                                ...
                                <div class="form-group col-md-12 no-padding">
                                    ...
                                    <div class="col-md-8">
                                        <input maxlength="200" type="text" required="required" name="bahan_bakar"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="header margin-bottom">
                                <h3>Penanggung Jawab Pengujian</h3>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group col-md-12 no-padding">
                                    <label class="control-label col-md-3">Nama <a style="text-decoration:none;font-size: 1em">*</a></label>
                                    <div class="col-md-9">
                                        <input maxlength="200" type="text" required="required" name="nama_tester"
                                               value="{{ $tester->nama }}"
                                ...
                                <div class="form-group col-md-12 no-padding">
                                    ...
                                    <div class="col-md-9">
                                        <input maxlength="200" type="text" required="required" name="nip"
                                               value="{{ $tester->nip }}"
                                ...
                                <div class="form-group col-md-12 no-padding">
                                    ...
                                    <div class="col-md-9">
                                        <input maxlength="200" type="text" required="required" name="jabatan"
                                               value="{{ $tester->jabatan }}"
                ...
                @foreach($steps as $step)
                    <div class="row setup-content" id="step-{{$loop->iteration +1}}">
                        <div class="col-md-12">
                            <p class="text-center text-uppercase h3 margin-bottom">
                            ...
                            @php
                                ...
                                {
                                    if(!$testResult->contains('check_id', $check->id))
                                    {
                                        $counter ++;
                                    }
                                }
                            ...
                            @if($counter == 0)
                                <div class="callout callout-success">
                                    <p class="text-center h4">
                                        <span style="vertical-align: middle" class="fa fa-check-circle fa-2x"></span>
                                        &nbsp;&nbsp;
                                        <span style="vertical-align: middle">Complete</span>
                                    </p>
                                </div>

                            @elseif ($counter <= 8)
                                <div class="text-center" style="padding-bottom: 10px;">
                                    <span class="label label-danger">{{ $counter }} Belum Complete</span>
                                    <span class="label label-success">{{ $len - $counter }} Complete</span>
                                </div>
                                @foreach($step->checks()->get() as $check)
                                    @if(!$testResult->contains('check_id', $check->id))
                            ...
                            @else
                                ...
                                @foreach($step->checks()->get()->chunk(ceil($counter/2)) as $check_c)
